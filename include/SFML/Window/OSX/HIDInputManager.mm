...
////////////////////////////////////////////////////////////
bool HIDInputManager::isKeyPressed(Input::Keyboard->Key key)
{
...
void HIDInputManager::loadKey(IOHIDElementRef key)
{
    ...
    if (error == noErr)
    {
        ...
        Input::Keyboard->Key code = Input::Keyboard->Unknown; // KeyCound means 'none'
        ...
        if (code == Input::Keyboard->Unknown)
        ...
        //if (code == Input::Keyboard->Unknown) { // The key is unknown.
...
void HIDInputManager::freeUp()
{
    ...
    for (unsigned int i = 0; i < Input::Keyboard->KeyCount; ++i)
    {
...
////////////////////////////////////////////////////////
Input::Keyboard->Key HIDInputManager::localizedKeys(UniChar ch)
{
    switch (ch)
    {
        case 'a':
...
////////////////////////////////////////////////////////
Input::Keyboard->Key HIDInputManager::nonLocalizedKeys(UniChar virtualKeycode)
{
