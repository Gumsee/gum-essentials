...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool isKeyPressed(Input::Keyboard->Key key);
...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    static Input::Keyboard->Key localizedKeys(UniChar ch);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static Input::Keyboard->Key nonLocalizedKeys(UniChar virtualKeycode);
...
private:
    ...
    IOHIDElements     m_keys[Input::Keyboard->KeyCount];   ///< All the keys on any connected keyboard
